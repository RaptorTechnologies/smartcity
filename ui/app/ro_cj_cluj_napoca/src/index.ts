...
import {pageProvisioningProvider} from "@openremote/manager/pages/page-provisioning";
import {combineReducers, configureStore} from "@reduxjs/toolkit";
import {AppConfig, appReducer, HeaderConfig, HeaderItem, PageProvider, RealmAppConfig} from "@openremote/or-app";
import {
    headerItemAccount,
    headerItemAssets,
...
const orApp = new CustomApp(store);
